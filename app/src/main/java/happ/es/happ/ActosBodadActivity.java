...
public class ActosBodadActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actos_bondad);
        ...
        mostrarInstrucciones = intent.getBooleanExtra(ConstantesActosBondad.MOSTRAR_INSTRUCCIONES, true);
    ...
    public void irActosBondadMenu(View view) {
        Intent intent = new Intent(this, ActosBodadActivity.class);
        intent.putExtra(ConstantesActosBondad.MOSTRAR_INSTRUCCIONES, false);
        finish();
